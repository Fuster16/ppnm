...
public static implicit operator double[] (vector v){ return v.data; } // Allows for "vector v" to be parsed as it's "double[]" data representation
...
public double norm(){ //What?? It works tho
